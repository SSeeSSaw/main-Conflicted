...
class JsonAdaptedFreshman extends JsonAdaptedPerson{
     ...
     */
    @JsonCreator
    public JsonAdaptedFreshman(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
     ...
     */
    public JsonAdaptedFreshman(Participant source) {
        super(source);
    ...
    public Participant toModelType() throws IllegalValueException {
        final List<Tag> freshmanTags = new ArrayList<>();
        for (JsonAdaptedTag tag : tagged) {
            freshmanTags.add(tag.toModelType());
        }
        ...
        final Set<Tag> modelTags = new HashSet<>(freshmanTags);
